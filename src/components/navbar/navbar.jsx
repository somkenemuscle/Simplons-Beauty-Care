                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                <Link className="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false" to="/products">Products</Link>
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" aria-current="page" to="/cart">Cart <HiOutlineShoppingCart /></Link>
                            </li>
                        </ul>
                    </div>
                </div>
